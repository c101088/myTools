...
OpenCmdInCurrent()
{
    ...
    if InStr(res_path, ":")!=0
    {
        ...
        Run,  wt.exe -d "%res_path%";focus-tab -t 1
    }
    else
    {
        Run,  wt.exe -d "C:/";focus-tab -t 1
    }
...
;-----------------------------------o---------------------------------o
;This i may be satisfied with win key to control the global applications
;# & d:: Send, !d                                              ;|
;# & f:: Send, !f                                              ;|
;# & e:: Run http://cn.bing.com/                               ;|
;# & r:: Run Powershell                                        ;|
